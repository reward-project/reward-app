...
abstract class AppLocalizations {
  ...
  /// No description provided for @emailSendSuccess.
  ///
  /// In en, this message translates to:
  /// **'Verification code has been sent'**
  String get emailSendSuccess;

  /// No description provided for @emailSendFail.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @emailVerifyFail.
  ///
  /// In en, this message translates to:
  /// **'Email verification failed'**
  String get emailVerifyFail;
  ...
  /// No description provided for @signupFail.
  ///
  /// In en, this message translates to:
  /// **'Sign up failed'**
